...
const Navbar: React.FC = () => {
  ...
  try {
    // Avoid parsing if user is null or the string "undefined"
    userData = user && user !== "undefined" ? JSON.parse(user) : null;
  } catch (error) {
      ...
      <div className="navbar-container">
        ...
        <div className={`user-section ${isMobileMenuOpen ? 'active' : ''}`}>
          ...
          <ul className={`nav-menu ${isMobileMenuOpen ? 'active' : ''}`}>
            ...
            <li className="nav-item">
              <Link to="/blogs" className="nav-link">Explore</Link>
            </li>
            ...
            {token ? (
              <>
                ...
                <li className="nav-item">
                <Link to={`/profile/${userData?.id}`} className="nav-link">Profile</Link>
                </li>
                <li className="nav-item">
