  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setErrorMessage(errorData.error || "Failed to submit blog post.");
      }
    } catch (error) {
    ...
    <div className="create-blog-page">
      ...
      <form className="blog-form" onSubmit={handleSubmit}>
        <div className="form-content">
          ...
          <div className="form-group">
            <label htmlFor="excerpt" className="form-label">Excerpt (Short Description)</label>
            <textarea
              id="excerpt"
              name="excerpt"
              rows={3}
          ...
          <div className="publish-options">
            <div className="radio-option">
              ...
              />
              <label htmlFor="draft" className="radio-label">Save as Draft</label>
            </div>
            <div className="radio-option">
              <input
                id="published"
                ...
                className="radio-input"
              />
              <label htmlFor="published" className="radio-label">Publish Now</label>
            </div>
